...
smd({
  ...
  try {
    ...
    await _0x1c0160.error(_0x4adf95 + "\n\ncommand: Mchat", _0x4adf95, "*_Sorry your message no answers from the PETER-MD Mchat, Sorry!!!_*");
  }
});
smd({
  pattern: "gpt",
  ...
  try {
    ...
    await _0x5cb388.error(_0x2ef914 + "\n\ncommand: gpt", _0x2ef914, "*_Sorry your message no answers from the PETER-MD gpt, Sorry!!!_*");
  }
});
smd({
  pattern: "fgpt",
  ...
  try {
    ...
    await _0x42b3b8.error(_0x70fc81 + "\n\ncommand: fgpt", _0x70fc81, "*_Sorry your message no answers from the PETER-MD fgpt, Sorry! !!!_*");
  }
});
smd({
  pattern: "dalle",
  ...
  try {
    ...
    await _0x21be87.error(_0x25b4b9 + "\n\ncommand: dalle", _0x25b4b9, "*_Sorry your message no answers from the PETER-MD Dall-E Ai, Sorry!!_*");
  }
});
smd({
  pattern: "imagine",
...
smd({
  ...
  try {
    ...
    await _0x28a796.error(_0x166d80 + "\n\ncommand: rmbg", _0x166d80, "*_No response from PETER-MD remove.bg, Sorry!!_*");
  }
});
smd({
  pattern: "readmore",
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*PETER-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("PETER-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("VENOCYBER-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
...
// AI auto-reply for private non-command chats
smd({ on: "text" }, async (message, text, { icmd }) => {
  try {
    ...
    const reply = await aiResponce(message, "gpt", prompt);
    if (reply && typeof reply === "string" && reply.length > 0) {
      await message.reply(reply);
    }
  } catch (e) {
    console.log("auto-reply ai error:", e);
  }
});
