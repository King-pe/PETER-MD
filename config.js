...
global.audio = process.env.AUDIO || "https://od.lk/d/NzhfNTk5OTc4MjVf/Mrsky.mp3";
global.video = process.env.VIDEO || "";
...
global.scan = process.env.APP_URL || "";
...
module.exports = {
  ...
  VERSION: process.env.VERSION || "2.6.0",
