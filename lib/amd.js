  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|PETER|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.PETER/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0 || !_0x3bceba) && /text|txt|nothing|smd|PETER/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
...
async function loadPlugins(_0x31a795) {
  try {
    fs.readdirSync(_0x31a795).forEach(_0x340012 => {
      ...
      } else if ([".js", ".smd", ".PETER"].includes(path.extname(_0x340012).toLowerCase())) {
        try {
          require(_0x4c0490);
        } catch (_0xf3f8e5) {
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/PETER;;;/gi, "").replace(/Astro;;;/gi, "").replace(/King-pe;;;/gi, "").trim();
